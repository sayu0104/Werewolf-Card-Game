...
@Service
public class WerewolfService { // 人狼の役職について

	private static final String ROLE_NAME = "人狼";
	private static final String ACTION_TYPE = "襲撃";

	private final GamePlayerRepository gamePlayerRepository;
	private final RoleRepository roleRepository;
	private final NightActionRepository nightActionRepository;

	public WerewolfService(GamePlayerRepository gamePlayerRepository, RoleRepository roleRepository,
	...
	private GamePlayer chooseTarget(List<GamePlayer> alivePlayers, GamePlayer actor) {
		...
		// 2.襲撃先が誰もいなかったら、生存者を候補にする（本人と仲間を含みうるが不具合なし）
		if (candidates.isEmpty()) {
			candidates = alivePlayers;
		}

		// 3.候補からランダムに襲撃先を決める（将来は頭脳的に）
